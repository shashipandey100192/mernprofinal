      ...
      <li className="mb-1">
        ...
        <div className="collapse show" id="home-collapse">
          ...
          <li><Link to="" className="link-body-emphasis d-inline-flex text-decoration-none rounded">Main</Link></li>
            ...
            <li><Link to="empdetails" className="link-body-emphasis d-inline-flex text-decoration-none rounded">Props</Link></li>
            <li><Link to="mychart" className="link-body-emphasis d-inline-flex text-decoration-none rounded">Charts</Link></li>
            <li><Link to="mylazypage" className="link-body-emphasis d-inline-flex text-decoration-none rounded">Lazyloading</Link></li>
            <li><Link to="reduxpage" className="link-body-emphasis d-inline-flex text-decoration-none rounded">redux</Link></li>
            <li><Link to="jsonpage" className="link-body-emphasis d-inline-flex text-decoration-none rounded">jsonpage</Link></li>
            <li><Link to="datatable" className="link-body-emphasis d-inline-flex text-decoration-none rounded">datatable</Link></li>
          </ul>
        </div>
      </li>
      <li className="mb-1">
